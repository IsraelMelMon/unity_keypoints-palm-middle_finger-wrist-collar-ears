...
public class PoseNetSample : MonoBehaviour
{
    ...
    void DrawResult()
    {
        ...
        for (int i = 0; i < len; i++)
        {
            ...
            Vector3 C = MathTF.Lerp(min, max, new Vector3(a.x, 1f - a.y, 0));
            Vector3 D = MathTF.Lerp(min, max, new Vector3(b.x, 1f - b.y, 0));
            Vector3 C2 = MathTF.Lerp(min, max, new Vector3(a.x*720f, (1f - a.y)*1080f, 0));
